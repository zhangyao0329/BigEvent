...
const login = async () => {
  ...
  if (valid) {
    ...
    router.push('/')
    // 设置一个定时器，在1000毫秒（即1秒）后执行刷新页面的操作
    setTimeout(function () {
      // 刷新当前页面
  ...
  <el-row class="login-page">
    <el-col :span="6" :offset="9" class="form">
      ...
      <el-form ref="form" size="large" autocomplete="on" v-if="isRegister" :model="registerData" :rules="rules">
        ...
        <el-form-item>
          <el-button class="button" type="primary" auto-insert-space @click="isRegister = false; clearRegisterData()">
            注册完毕，点我返回登录
          </el-button>
        </el-form-item>
      </el-form>
      ...
      <el-form ref="form" size="large" autocomplete="off" v-else :model="registerData" :rules="rules">
        ...
        <el-form-item>
          <el-button class="button" type="primary" auto-insert-space @click="isRegister = true; clearRegisterData()">
            没用账号，点我注册
          </el-button>
        </el-form-item>
      </el-form>
...
.login-page {
  height: 100vh;
  background: url('https://cdn.jsdelivr.net/gh/zhangyao0329/tuchuang-blog/tuchuang-blog/202405281957972.jpg');
